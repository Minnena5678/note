...
if (!isset($_SESSION['email'])) {
    echo "กรุณาเข้าสู่ระบบก่อน <a href='userlogin.html'>คลิกที่นี่</a> เพื่อเข้าสู่ระบบ";
    exit();
}
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        $htmlOutput .= "<h2 class='custom-title'>" . ($type === 'public' ? 'โดยสารสาธารณะ' : 'โดยสารส่วนตัว/รถราง') . "</h2>";
